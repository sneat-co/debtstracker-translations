...
You invitation code is: {{.InviteCode}}`,
	...
	WS_SHORT_DESC: map[string]string{
		...
		"fr-FR": "DebtsTracker est une des applications mobiles et rappel service qui permet de suivre vos dettes et crédits. Envoie automatisés email & SMS notifications à vos débiteurs.",
